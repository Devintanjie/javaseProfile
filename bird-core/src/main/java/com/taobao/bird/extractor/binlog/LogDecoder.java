...
import com.taobao.bird.extractor.binlog.event.AppendBlockLogEvent;
import com.taobao.bird.extractor.binlog.event.BeginLoadQueryLogEvent;
import com.taobao.bird.extractor.binlog.event.CreateFileLogEvent;
import com.taobao.bird.extractor.binlog.event.DeleteFileLogEvent;
import com.taobao.bird.extractor.binlog.event.DeleteRowsLogEvent;
import com.taobao.bird.extractor.binlog.event.ExecuteLoadLogEvent;
import com.taobao.bird.extractor.binlog.event.ExecuteLoadQueryLogEvent;
import com.taobao.bird.extractor.binlog.event.FormatDescriptionLogEvent;
import com.taobao.bird.extractor.binlog.event.GtidLogEvent;
import com.taobao.bird.extractor.binlog.event.HeartbeatLogEvent;
import com.taobao.bird.extractor.binlog.event.IgnorableLogEvent;
import com.taobao.bird.extractor.binlog.event.IncidentLogEvent;
import com.taobao.bird.extractor.binlog.event.IntvarLogEvent;
import com.taobao.bird.extractor.binlog.event.LoadLogEvent;
import com.taobao.bird.extractor.binlog.event.LogHeader;
import com.taobao.bird.extractor.binlog.event.PreviousGtidsLogEvent;
import com.taobao.bird.extractor.binlog.event.QueryLogEvent;
import com.taobao.bird.extractor.binlog.event.RandLogEvent;
import com.taobao.bird.extractor.binlog.event.RotateLogEvent;
import com.taobao.bird.extractor.binlog.event.RowsLogEvent;
import com.taobao.bird.extractor.binlog.event.RowsQueryLogEvent;
import com.taobao.bird.extractor.binlog.event.StartLogEventV3;
import com.taobao.bird.extractor.binlog.event.StopLogEvent;
import com.taobao.bird.extractor.binlog.event.TableMapLogEvent;
import com.taobao.bird.extractor.binlog.event.UnknownLogEvent;
import com.taobao.bird.extractor.binlog.event.UpdateRowsLogEvent;
import com.taobao.bird.extractor.binlog.event.UserVarLogEvent;
import com.taobao.bird.extractor.binlog.event.WriteRowsLogEvent;
import com.taobao.bird.extractor.binlog.event.XidLogEvent;
